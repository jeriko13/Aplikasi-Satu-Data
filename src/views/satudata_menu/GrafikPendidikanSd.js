...
export default function GrafikPendidikanSd() {
    useEffect(() => {
      (async () => {
        const resPendidikan = await Axios.get(`${API_URL}/api/list/grafik_pendidikan_sd`).then(res => res.data.grafik_pendidikan_sd);
        let config = {
        type: "bar",
        data: {
