...
export default function GrafikPendidikanTk() {
    useEffect(() => {
      (async () => {
        const resPendidikan = await Axios.get(`${API_URL}/api/list/grafik_pendidikan_tk`).then(res => res.data.grafik_pendidikan_tk);
        let config = {
        type: "bar",
        data: {
